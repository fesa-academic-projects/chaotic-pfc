...
class TestLyapunov(unittest.TestCase):
    ...
    def test_positive_exponent(self):
        ...
        self.assertGreater(
            result["lyapunov_max"], 0, "Standard Hénon (no filter) should have positive λ_max"
        )
    ...
    def test_henon2d_chaotic(self):
        ...
        self.assertGreater(res["lyapunov_max"], 0.3, "2-D Hénon λ_max should be ~0.42")
...
class TestLyapunovEnsemble(unittest.TestCase):
    ...
    def test_aggregates_match_arrays(self):
        ...
        np.testing.assert_allclose(
            r.mean_exponents,
            r.exponents_per_ci.mean(axis=0),
        )
    ...
    def test_determinism_with_seed(self):
        ...
        np.testing.assert_array_equal(r1.initial_conditions, r2.initial_conditions)
        np.testing.assert_array_equal(r1.exponents_per_ci, r2.exponents_per_ci)
    ...
    def test_2d_henon_is_chaotic_on_average(self):
        ...
        self.assertGreater(r.mean_lmax, 0.3, "Ensemble mean λ_max should be near 0.42")
